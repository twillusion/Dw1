...
// -------------------------------------------------------------------------
// Pixel-art sprite data  (18 × 18 grids from official Digimon v-pet art; '.' = transparent)
// -------------------------------------------------------------------------
const PIXEL_SPRITES = {
  Agumon: {
    pal: { K:'#111111', Y:'#f0c000', O:'#d07010', G:'#30a030' },
    px: [
      '..................',
      '..................',
      '.......KKKKK......',
  ...
  MetalGreymon: {
    pal: { K:'#111111', S:'#8899bb', O:'#d07010' },
    px: [
      '..................',
      '......KKKKKSSKKK..',
      '.KKSSKKKKKKKKKKK..',
  ...
  WarGreymon: {
    pal: { K:'#111111', R:'#991010', D:'#662200' },
    px: [
      '..................',
      '...KKRRRRRRRRKK...',
      '...KRKRKKKKKKRK...',
  ...
  MetalGarurumon: {
    pal: { K:'#111111', S:'#aabbdd', W:'#ddeeff' },
    px: [
      '..................',
      '.....KKKSSSKKK....',
      '....KSSKSSKSSK....',
  ...
  Angemon: {
    pal: { K:'#111111', W:'#eeeeff', T:'#ddaa77' },
    px: [
      '..................',
      '....KKKKKKWWKK....',
      '...KWWWWWWKWWKK...',
  ...
  Birdramon: {
    pal: { K:'#111111', R:'#dd4400', D:'#882200' },
    px: [
      '..................',
      '....KKKKRRRRK.....',
      '.....KRRKRRRKK....',
  ...
  SkullGreymon: {
    pal: { K:'#111111', W:'#ddddcc', P:'#553366' },
    px: [
      '..................',
      '..KKKKK...........',
      '..KWWWWKKK........',
...
function makePixelArtTexture(name) {
  ...
  const art = PIXEL_SPRITES[name];
  const gridSize = art ? art.px[0].length : 18;
  const ps = Math.floor(288 / gridSize);   // 288 = 18*16; gives integer ps for 18-cell grids
  cv.width = cv.height = ps * gridSize;
  const ctx = cv.getContext('2d');
  drawPixelArt(ctx, name, ps);
...
function makeHudCanvas(name, hudSize = 48) {
  ...
  const art = PIXEL_SPRITES[name];
  const gridSize = art ? art.px[0].length : 18;
  const ps = Math.floor(hudSize / gridSize);
  cv.width = cv.height = ps * gridSize;
...
function initFighterSprites(playerData, opponentData) {
  ...
  fighters.player.sprite.scale.x *= -1;   // mirror: all sprites face left, player faces right toward opponent
