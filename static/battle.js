...
// -------------------------------------------------------------------------
// Sprites derived from reference images (7) + hand-crafted (3: MetalGreymon, WarGreymon, MetalGarurumon)
const PIXEL_SPRITES = {
  Agumon: {
    pal: { K:'#181518',A:'#453d2b',B:'#7a5e18',C:'#5c5e60',D:'#ac8a15',E:'#d4a813',F:'#f5ca07' },
    px: [
      '....KKKBDED.....',
      '.ADBBBDEDEEA....',
      'DEEFFFFAAADDA...',
  ...
  Greymon: {
    pal: { K:'#161218',A:'#332621',B:'#423a36',C:'#654e38',D:'#866730',E:'#6e6b6c',F:'#aa9026' },
    px: [
      '...CE........B..',
      '...CBAKBBE.CBB..',
      '...EBKCCBAAB....',
  ...
  MetalGreymon: {
    pal: { K:'#111111',A:'#7a4010',B:'#c06820',C:'#e89030',D:'#5c6468',E:'#9ca8b0',F:'#d8e4f0' },
    px: [
      '....KKKKKK......',
      '...KAACCCaK.....',
      '..KAACCCCAaK....',
  ...
  WarGreymon: {
    pal: { K:'#111111',A:'#5a1808',B:'#a03010',C:'#d05018',D:'#f07828',E:'#d4a020',F:'#f0cc30' },
    px: [
      '.....KKKKK......',
      '....KCCDDcK.....',
      '...KCKooKDCK....',
  ...
  Garurumon: {
    pal: { K:'#323032',A:'#5c5363',B:'#6e687d',C:'#7b7d94',D:'#8a8ca2',E:'#a1a7b5',F:'#95d1ee' },
    px: [
      '...DC....BC.....',
      '...CCC..ECB....C',
      '.FDAECCCEEBDE.EC',
  ...
  WereGarurumon: {
    pal: { K:'#000805',A:'#463a46',B:'#674835',C:'#575160',D:'#546387',E:'#7a727e',F:'#9095af' },
    px: [
      '......CFED......',
      '......EEEDDFC...',
      '.....EEDFDCEFDD.',
  ...
  MetalGarurumon: {
    pal: { K:'#282830',A:'#283448',B:'#404e6c',C:'#586890',D:'#8090b0',E:'#b0bccc',F:'#90d0f0' },
    px: [
      '...DC....BC.....',
      '...CCC..ECB....C',
      '.FDAECCCEEBDE.EC',
  ...
  Angemon: {
    pal: { K:'#2b2b2c',A:'#545762',B:'#69728e',C:'#848270',D:'#aea56c',E:'#939fae',F:'#b3c8d8' },
    px: [
      '.EA...........E.',
      '.FAK.......CEFE.',
      '.BAKK....EFFFFB.',
  ...
  Birdramon: {
    pal: { K:'#32282a',A:'#565248',B:'#9d4a22',C:'#8b5942',D:'#aa741d',E:'#db7713',F:'#8e7565' },
    px: [
      '............FCC.',
      'CCFF.......CACA.',
      'CBCF.......CBDAC',
  ...
  SkullGreymon: {
    pal: { K:'#323232',A:'#655e5a',B:'#716d6a',C:'#9a805e',D:'#837e7b',E:'#918d8a',F:'#a7a4a2' },
    px: [
      '.......CC.......',
      '.F..BFFCCA.FFFF.',
      '..EAAABBBAEEEFF.',
